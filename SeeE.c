...
void editRecord(struct records cRecords[], int * nNumber) {
  ...
  case 2:
    ...
    break;
  case 3:
    while (strcmp(cRecords[recordNum].cAnswer, newValue) != 0 &&
      strcmp(cRecords[recordNum].cAnswer, cRecords[recordNum].cChoice2) != 0 &&
      strcmp(cRecords[recordNum].cAnswer, cRecords[recordNum].cChoice3) != 0) {
    ...
    break;
  case 4:
    while (strcmp(cRecords[recordNum].cAnswer, cRecords[recordNum].cChoice1) != 0 &&
      strcmp(cRecords[recordNum].cAnswer, newValue) != 0 &&
      strcmp(cRecords[recordNum].cAnswer, cRecords[recordNum].cChoice3) != 0) {
      printf("None of the Choices correspond to the answer. Please input a valid answer\n");
      system("pause");
      system("cls");
  ...
  case 5:
    ...
    break;
  case 6:
    while (strcmp(newValue, cRecords[recordNum].cChoice1) != 0 &&
      strcmp(newValue, cRecords[recordNum].cChoice2) != 0 &&
      strcmp(newValue, cRecords[recordNum].cChoice3) != 0) {
